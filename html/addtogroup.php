...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    $user_id_to_check = 1;
    $sql1 = "UPDATE account SET Group_Name=? WHERE USER_ID=?";
    mysqli_error($conn);
    if($stmt1 = mysqli_prepare($conn, $sql1))
        mysqli_stmt_bind_param($stmt1, "ss",$group_name,$user_id_to_check);
...
echo'
    ...
    <form action="" method="post">
        ...
        <input type="text" id="fname" name="fname" placeholder="Aditya" value="' .$row['FIRSTNAME'] .'"  required disabled><br>
        <div class="col-25">
        ...
        <input type="text" id="username" name="username" placeholder="Group_Name" value="' .$row['Group_Name'] .'" autofocus required>
